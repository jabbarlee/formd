...
import { Download, TrendingUp, Users, Clock, Monitor, Smartphone, Tablet, Globe } from "lucide-react";
        ...
        <div>
          ...
          <div className="flex items-center justify-between mt-4">
            <div>
              ...
              <p className="text-muted-foreground">Detailed insights for your form</p>
            </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">1,842 (100%)</span>
                      </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">1,456 (79%)</span>
                      </div>
                      <div className="h-3 bg-muted rounded-full overflow-hidden">
                        <div className="h-full bg-indigo-600" style={{ width: "79%" }} />
                      </div>
                    </div>
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-medium">50% Complete</span>
                        <span className="text-sm text-muted-foreground">892 (48%)</span>
                      </div>
                      <div className="h-3 bg-muted rounded-full overflow-hidden">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">234 (13%)</span>
                      </div>
                      <div className="h-3 bg-muted rounded-full overflow-hidden">
                        <div className="h-full bg-indigo-600" style={{ width: "13%" }} />
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-muted-foreground">142 responses (61%)</span>
                    </div>
                    <div className="h-3 bg-muted rounded-full overflow-hidden">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-muted-foreground">68 responses (29%)</span>
                    </div>
                    <div className="h-3 bg-muted rounded-full overflow-hidden">
                      <div className="h-full bg-indigo-600" style={{ width: "29%" }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-muted-foreground">24 responses (10%)</span>
                    </div>
                    <div className="h-3 bg-muted rounded-full overflow-hidden">
                ...
                <div className="space-y-4">
                  <div className="h-64 flex items-center justify-center bg-muted/50 rounded-lg mb-6">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">World map placeholder</p>
                    </div>
                  </div>
                      ...
                      <div key={i} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="w-20 h-2 bg-muted rounded-full overflow-hidden">
                            <div className="h-full bg-indigo-600" style={{ width: `${item.percentage * 2.5}%` }} />
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="q1">
                    <AccordionTrigger>
                      <div className="flex items-center justify-between w-full pr-4">
                        <span className="font-medium">Q1: How would you rate our service?</span>
                  ...
                  <AccordionItem value="q2">
                    <AccordionTrigger>
                      <div className="flex items-center justify-between w-full pr-4">
                        <span className="font-medium">Q2: Would you recommend us to others?</span>
                        <Badge variant="secondary">234 responses</Badge>
                      </div>
                    </AccordionTrigger>
                    <AccordionContent>
                  ...
                  <AccordionItem value="q3">
                    <AccordionTrigger>
                      <div className="flex items-center justify-between w-full pr-4">
                        <span className="font-medium">Q3: What features do you use most?</span>
                        <Badge variant="secondary">234 responses</Badge>
                      </div>
                    </AccordionTrigger>
                    <AccordionContent>
                      <div className="space-y-3 pt-2">
                        {[
                          { option: "AI Form Generation", count: 198, percentage: 85 },
                          { option: "Analytics Dashboard", count: 176, percentage: 75 },
                          { option: "Custom Branding", count: 134, percentage: 57 },
                          { option: "Team Collaboration", count: 89, percentage: 38 },

/**
 * GET /api/forms/[id]/analytics/overview
 * Get overview metrics only (for quick updates)
 * 
...
export async function GET(request: NextRequest, { params }: RouteContext) {
  try {
    ...
    const overview = await analyticsService.getOverviewMetrics(formId, timeRange);
